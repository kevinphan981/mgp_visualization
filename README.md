...
Code on the website's structure. Includes the Home page, where the MGP Visualization will be displayed, and the About page, where details on us and the project are located.
