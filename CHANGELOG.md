...
# Tasks
1. Begin writing extensive code to fetch advanced queries
2. Make Observable HQ notebook but also store code here.
3. Maybe just make something and figure out the details later.